        ...
        <div className="container-fluid animate__animated animate__fadeIn p-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div className="d-flex align-items-center bg-white shadow-sm px-3 py-2" style={{ borderRadius: '10px', border: '1px solid #eee' }}>
                    ...
                    <span className="fw-bold text-dark">{clients.length} un.</span>
                </div>
            </div>
                    ...
                    <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '15px' }}>
                        ...
                        <form onSubmit={handleUpdate}>
                            ...
                            <div className="modal-footer border-0 p-4 pt-0">
                                ...
                                <button type="submit" className="btn btn-primary px-4 fw-semibold">Guardar Cambios</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <style>{`
                ...
                /* Estilo Profesional para el Rol */
                .role-text {
                    font-size: 11px;
                    font-weight: 600;
