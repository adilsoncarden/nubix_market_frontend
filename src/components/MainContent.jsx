...
const PROMOCIONES_TOP = [
    ...
    },
    {
        ...
        sub: "20% DSCTO en desodorantes",
        img: "https://images.unsplash.com/photo-1556229167-73191139ac06?w=1600&q=80",
    },
    {
        titulo: "ZONA LIMPIEZA",
        sub: "Todo para tu hogar aquí",
        img: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=1600&q=80",
    },
    {
        titulo: "MUNDO MASCOTAS",
        sub: "Croquetas con 15% de descuento",
...
export const CATEGORIAS_DATA = [
    ...
    {
        nombre: "Frutas",
        img: "https://images.unsplash.com/photo-1619566636858-adf3ef46400b?w=200&q=80",
        color: "#f1f8e9",
        text: "#2e7d32",
    },
    {
    ...
    {
        nombre: "Snacks",
        img: "https://tse2.mm.bing.net/th/id/OIP.mkWFpeW-AOHmEu6kqN1IpAHaJz?pid=Api&P=0&h=180",
        color: "#fce4ec",
        text: "#c62828",
    },
    {
    ...
    {
        nombre: "Bebidas",
        img: "https://tse1.mm.bing.net/th/id/OIP.hF6gCMuONIZoD4N0TpqxuwHaHa?pid=Api&P=0&h=180",
        color: "#e0f2f1",
        text: "#00695c",
    },
];
...
const PRODUCTOS = [
    {
        ...
        tag: "Fresco",
        tagColor: "tag-green",
        img: "https://media.tottus.com.pe/tottusPE/10161826_1/width=480,height=480,quality=70,format=webp,fit=pad",
    },
    {
        id: 2,
        nombre: "Coca Cola 3L",
        ...
        tag: "Popular",
        tagColor: "tag-blue",
        img: "https://media.tottus.com.pe/tottusPE/10164192_1/width=480,height=480,quality=70,format=webp,fit=pad",
    },
    {
        id: 3,
        ...
        tag: "Básico",
        tagColor: "tag-yellow",
        img: "https://tse3.mm.bing.net/th/id/OIP.678KDktTo1zSZ8U1nvhGdAHaHa?pid=Api&P=0&h=180",
    },
    {
        id: 4,
        ...
        tag: "Oferta",
        tagColor: "tag-red",
        img: "https://media.tottus.com.pe/tottusPE/42757360_2/width=480,height=480,quality=70,format=webp,fit=pad",
    },
    {
        id: 5,
        nombre: "Papas Nativas 1kg",
        cat: "Frutas",
        precio: 4.5,
        tag: "Orgánico",
        tagColor: "tag-green",
        img: "https://media.tottus.com.pe/tottusPE/20014196_1/width=480,height=480,quality=70,format=webp,fit=pad",
    },
    {
        id: 6,
        ...
        tag: "Limpieza",
        tagColor: "tag-blue",
        img: "https://tse1.mm.bing.net/th/id/OIP.wbp2VG1zCwldW2Fe2XY98wHaHa?pid=Api&P=0&h=180",
    },
    {
        id: 7,
        nombre: "Yogurt Griego 1kg",
        cat: "Lácteos",
        precio: 12.5,
        tag: "Saludable",
        tagColor: "tag-yellow",
        img: "https://media.falabella.com/tottusPE/42736718_1/w=1200,h=1200,fit=pad",
    },
    {
        id: 8,
        ...
        tag: "Crunchy",
        tagColor: "tag-red",
        img: "https://media.tottus.com.pe/tottusPE/43526445_2/width=480,height=480,quality=70,format=webp,fit=pad",
    },
];
...
const BENEFICIOS = [
    { icono: "bi-truck", titulo: "Envio Rapido", sub: "Directo a tu casa" },
    {
        ...
        titulo: "Pago Seguro",
        sub: "Transacciones protegidas",
    },
    {
        icono: "bi-star",
        titulo: "Calidad Nubix",
        sub: "Productos seleccionados",
    },
    {
        icono: "bi-chat-dots",
        titulo: "Soporte Inmediato",
        sub: "Atencion personalizada",
    },
];
    ...
    return (
        <div className="col">
            <div className="product-card card border-0 h-100 rounded-4 overflow-hidden shadow-sm">
                {p.tag && (
                    <span className={`product-tag ${p.tagColor}`}>{p.tag}</span>
                )}
...
const CategoryCard = ({ item }) => (
    <div className="col-4 col-md-2">
        ...
        >
            <div
                className="cat-icon-wrap mx-auto mb-2"
            ...
            <span
                className="cat-label"
                style={{ color: item.text, fontWeight: "600" }}
            >
                {item.nombre}
            </span>
        </Link>
            ...
            <div className="container-fluid px-0">
                <div className="track-container">
                    <div className="track-content">
                        {[...PROMOCIONES_TOP, ...PROMOCIONES_TOP].map(
                            (promo, index) => (
                                        ...
                                        >
                                            <div
                                                style={{
                                                    position: "absolute",
                                                    inset: 0,
                                                    background: `linear-gradient(90deg, ${VERDE_NUBIX} 10%, rgba(40,167,69,0.3) 100%)`,
                                                }}
                                            ></div>
                                        </div>
                                        <div
                                        ...
                                        >
                                            <div className="row align-items-center flex-nowrap g-0">
                                                <div className="col-auto">
                                                    <h2 className="mb-0 fw-black text-white promo-title-styled">
                                                        {promo.titulo}
                                                    </h2>
                                                </div>
                                                <div
                                                ...
                                                <div className="col-auto">
                                                    <p
                                                        className="mb-0 fw-bold text-white text-uppercase"
                                                        style={{
                                                            fontSize: "0.85rem",
                                                        }}
                                                    >
                    ...
                    {SLIDES_FIXED.map((s, i) => (
                        ...
                        >
                            <Link to={s.to}>
                                <img
                                    src={s.img}
                                    className="hero-img d-block w-100 h-100"
                                    alt="slide"
                                />
                            </Link>
                        </div>
                    ...
                    <div className="row g-3 text-center">
                        {BENEFICIOS.map((b) => (
                            <div key={b.titulo} className="col-6 col-md-3">
                                <i
                                    className={`bi ${b.icono} benefit-icon mb-2 d-block fs-2`}
                                ></i>
                                <p className="benefit-title mb-0 fw-bold">
                                    {b.titulo}
                                </p>
                                <small className="benefit-sub text-muted">
                                    {b.sub}
                                </small>
                            </div>
                        ))}
            ...
            <section className="container py-5">
                ...
                <div className="row g-3">
                    {CATEGORIAS_DATA.map((item) => (
                        <CategoryCard key={item.nombre} item={item} />
                    ))}
                </div>
            </section>
                ...
                <div className="row g-4">
                    <div className="col-12">
                        <div className="collage-main-card d-flex align-items-center p-5 shadow-lg overflow-hidden">
                            <div className="row w-100 align-items-center">
                                <div
                                    className="col-md-6 text-center d-none d-md-block position-relative"
                                    style={{ height: "300px" }}
                                >
                                    <img
                                ...
                                <div className="col-md-6">
                                    <h1
                                        className="fw-black display-4 mb-3"
                                        style={{ color: "#0d2b22" }}
                                    >
                                        Frutas y Verduras.
                                        <br />
                                    ...
                                    <p className="text-muted fs-5 mb-4">
                                        La mejor calidad seleccionada para tu
                                        hogar.
                                    </p>
                                    <Link
                                        to="/shop"
                        ...
                        <div className="collage-sub-card bg-3d-green shadow-lg">
                            <div className="text-3d-front text-white">
                                <h4 className="fw-bold">
                                    10% DE AHORRO EN TU PRIMERA COMPRA
                                </h4>
                            </div>
                            <img
                            ...
                            <div className="text-3d-front d-flex justify-content-between align-items-center">
                                <span className="text-white-50 small">
                                    Regístrate hoy para tu primer pedido.
                                </span>
                                <button className="btn-go-black">
                    ...
                    <div className="col-md-4">
                        <div className="collage-sub-card bg-3d-pink shadow-lg">
                            ...
                            >
                                <h4 className="fw-bold">
                                    ENVÍO GRATIS POR COMPRAS MAYORES A 100 SOLES
                                </h4>
                            </div>
                            <img
                                src="https://images.unsplash.com/photo-1610348725531-843dff563e2c?w=600"
                                className="blob-frame"
                                alt="promo2"
                            />
                            <div className="text-3d-front d-flex justify-content-between align-items-center">
                                <span
                                    ...
                                    style={{ color: "#880e4f" }}
                                >
                                    Abastece tu despensa sin costo extra.
                                </span>
                                <button className="btn-go-black">
                                    <i className="bi bi-chevron-right"></i>
                                </button>
                        ...
                        <div className="collage-sub-card bg-3d-yellow shadow-lg">
                            ...
                            <div className="text-3d-front d-flex justify-content-between align-items-center">
                                <span
                                    ...
                                    style={{ color: "#333" }}
                                >
                                    Lo mejor del mercado directo a tu mesa.
                                </span>
                                <button className="btn-go-black text-white">
                                    <i className="bi bi-chevron-right"></i>
                                </button>
                            </div>
                        </div>
